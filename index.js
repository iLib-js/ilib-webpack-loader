/**
 * index.js - A Webpack loader to process js files and insert
 * requires for all of the data that is needed for all the 
 * requested locales
 *
 * @license
        ...
        locales.forEach(function(locale) {
            localeData.forEach(function(filename) {
                ...
                if (filename === "charset" || filename === "charmaps") {
                    ...
                    if (!lang2charset) {
                        lang2charset = require("ilib/locale/lang2charset.json");
                    }
    ...
    var processDefineLocaleData = function (text) {
        ...
        if ((match = defineLocaleDataPattern.exec(partial)) !== null) {
            ...
            if (options.assembly === "dynamic") {
                output +=
                    "ilib.WebpackLoader = require('ilib/lib/WebpackLoader.js');\n" +
